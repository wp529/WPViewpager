 ...
 */
public class ImageLocalAdapter extends PagerAdapter {
    private int[] images;
    private int count;
    ...
    public ImageLocalAdapter(Context ctx, final ViewPager vp, int[] images, boolean looper, long time) {
        this.images = images;
        this.time = time;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(images[position % count]);
